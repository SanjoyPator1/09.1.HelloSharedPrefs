...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        ...
        preferencesEditor.putInt(COUNT_KEY, mCount);    //just a key-value pair
    ...
    public void reset(View view) {
        ...
        preferencesEditor.clear();  //Delete all the shared preferences:

        preferencesEditor.apply();  //Apply the changes:
